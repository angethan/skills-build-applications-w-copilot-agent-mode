        ...
        <div className="card-body">
          <form className="row g-2 align-items-end mb-3" onSubmit={(e) => e.preventDefault()}>
            <div className="col-12 col-md-8">
              <label htmlFor="teams-search" className="form-label fw-semibold">Search Teams</label>
              <input id="teams-search" type="text" className="form-control" placeholder="Filter by any value"
