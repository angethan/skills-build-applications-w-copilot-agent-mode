        ...
        <div className="card-body">
          <form className="row g-2 align-items-end mb-3" onSubmit={(e) => e.preventDefault()}>
            <div className="col-12 col-md-8">
              <label htmlFor="leaderboard-search" className="form-label fw-semibold">Search Leaderboard</label>
              <input id="leaderboard-search" type="text" className="form-control" placeholder="Filter by any value"
              ...
              <table className="table table-striped table-hover table-bordered align-middle mb-0">
                ...
                <tbody>
                  {filteredItems.length === 0 ? (
                    <tr><td colSpan="5" className="text-center text-muted py-4">No leaderboard entries found.</td></tr>
